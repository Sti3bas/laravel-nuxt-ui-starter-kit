...
<template>
    ...
    <UMain class="flex flex-col justify-center">
        <UContainer>
            <div class="mx-auto w-full max-w-[335px] rounded-lg py-24 sm:py-32 lg:max-w-4xl lg:py-40">
                    ...
                    <div class="flex w-full flex-col-reverse lg:flex-row">
                        <div class="flex flex-1 flex-col justify-center p-4 sm:p-6">
                            <div>
                                ...
                                >
                                    <template #title="{ item }">
                                        <ULink :href="item.link" target="_blank">
                                            <span class="truncate">
                                                {{ item.title }}

                                                <UIcon name="i-lucide-arrow-up-right" class="inline-block size-3 align-top" />
                                            </span>
                                        </ULink>
                                    </template>
                                </UTimeline>
                        ...
                        <div
                            class="relative aspect-335/376 w-full shrink-0 overflow-hidden rounded-t-lg border-l-1 border-(--ui-border) bg-[#fff2f2] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1D0002]"
                        >
                            <svg
    ...
    <USeparator icon="i-simple-icons:laravel" />
